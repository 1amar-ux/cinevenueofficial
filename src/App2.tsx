...
export default function App() {
  ...
  const [registeredUsers, setRegisteredUsers] = useState<{ email: string; passwordHash: string; joinedAt: string; mobile?: string; name?: string }[]>(() => {
    ...
    return saved ? JSON.parse(saved) : [
      { email: "amarnathgattem@gmail.com", passwordHash: "Amarnath123", joinedAt: "2026-07-01", mobile: "8465870811", name: "Amarnath Gattem" },
      { email: "member@cinevenue.com", passwordHash: "Member123", joinedAt: "2026-07-02", mobile: "9876543210", name: "Premium Member" }
    ];
  });

  // Credentials settings
  const [superAdminEmail, setSuperAdminEmail] = useState(() => localStorage.getItem("cine_sa_email") || "superadmin@cinevenue.com");
  const [superAdminPassword, setSuperAdminPassword] = useState(() => localStorage.getItem("cine_sa_pass") || "Amarnath123");
