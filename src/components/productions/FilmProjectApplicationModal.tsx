...
export default function FilmProjectApplicationModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center p-3 sm:p-6 bg-black/95 backdrop-blur-xl overflow-y-auto animate-fade-in cv-modal-overlay">
      <div className="relative w-full max-w-4xl bg-[#0C0D11] border border-gold/30 rounded-2xl shadow-2xl overflow-hidden my-auto flex flex-col max-h-[92vh] cv-modal-card">
